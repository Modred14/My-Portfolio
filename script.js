const work = ['Front-end Engineer', "Front-end Web Developer", "Frontend Developer", "Web Developer"]
...
const work2 = ['Front-end Engineer', "Front-end Web Developer", "Frontend Developer", "Web Developer"]
...
const work3 = ['Front-end Engineer', "Front-end Web Developer", "Frontend Developer", "Web Developer"]
...
function downloaded(){
    alert('Your download has started successfully and will be completed shortly. Check your files, typically in the download folder, for the "Omirin Favour Resume".')
}
